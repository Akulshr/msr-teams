# Application controller used to parse json data retrieved from the MSR "Tag deleted on repository" webhook event
...
def index():
    if request.method == 'POST':
        ...
        teams_data = {"@context": "https://schema.org/extensions", "@type": "MessageCard", "title": "Tag Deleted", "text": "User " + contents_author.strip('"') + " deleted tag " + contents_imageName + " at " + contents_deletedAt.strip('"')}
