# Application controller used to parse json data retrieved from the MSR "Tag pushed to repository" webhook event
...
def index():
    if request.method == 'POST':
        ...
        # teams_data = {"text": "User " + contents_author.strip('"') + " pushed tag " + contents_imageName + " at " + contents_pushedAt.strip('"')}
        teams_data = {"@context": "https://schema.org/extensions", "@type": "MessageCard", "title": "Image Pushed", "text": "User " + contents_author.strip('"') + " pushed tag " + contents_imageName + " at " + contents_pushedAt.strip('"')}
